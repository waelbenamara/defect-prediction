...
X = df[['loc','v(g)','n','v','lOComment','uniq_Op','uniq_Opnd','total_Op','total_Opnd']].to_numpy()
...
clf = MLPClassifier(max_iter = 1000,verbose = True,activation = 'relu',alpha = 0.1,hidden_layer_sizes = (20),learning_rate = 'constant',solver = 'adam')
